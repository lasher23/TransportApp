...
public class TransportTest {
  ...
  @Test
  public void testName() throws PublicTransportServiceUnvailableException {
    Transport transport = new Transport();
    LocalDateTime dateTime = LocalDateTime.of(2017, 5, 22, 14, 05);
    Connections connections = transport.getConnections("Sursee", "Luzern", dateTime);
    assertNotNull(connections.getConnections().get(0));
    assertNotNull(connections.getConnections().get(0).getFrom().getDeparture().toString());
  }
}
